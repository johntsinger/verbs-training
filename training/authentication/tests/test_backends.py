...
class TestEmailBackend(TestDataMixin, TestCase):
    ...
    def test_authenticate_incorrect_email(self):
        self.assertIsNone(authenticate(email="incorrect@email.com", password="pasword"))

    def test_authenticate_incorrect_password(self):
        self.assertIsNone(authenticate(email="user@email.com", password="incorrect"))
    ...
    def test_authenticate_success(self):
        self.assertEqual(
            authenticate(email="user@email.com", password="password"), self.user
        )
