...
from django.forms.fields import EmailField, Field
...
class TestLoginForm(TestDataMixin, TestCase):
    ...
    def test_email_field_label_not_set(self):
        ...
        self.assertEqual(form.fields["email"].label, capfirst(email_field.verbose_name))
    ...
    def test_email_does_not_exists(self):
        ...
        self.assertEqual(
            form.non_field_errors(), [form.error_messages.get("invalid_login")]
        )
    ...
    def test_invalid_email(self):
        ...
        form = self.form_class(data=data)
        self.assertFalse(form.is_valid())
        self.assertEqual(form["email"].errors, [EmailValidator.message])
    ...
    def test_blank_email(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(
            form["email"].errors, [Field.default_error_messages.get("required")]
        )
    ...
    def test_blank_password(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(
            form["password"].errors, [Field.default_error_messages.get("required")]
        )
    ...
    def test_inactive_user_error(self):
        ...
        form = self.form_class(data=data)
        self.assertFalse(form.is_valid())
        self.assertEqual(form.non_field_errors(), [form.error_messages.get("inactive")])
...
class TestSingupForm(TestDataMixin, TestCase):
    ...
    def test_blank_username(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(
            form["username"].errors, [Field.default_error_messages.get("required")]
        )
    ...
    def test_blank_password1(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(
            form["password1"].errors, [Field.default_error_messages.get("required")]
        )
    ...
    def test_blank_password2(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(
            form["password2"].errors, [Field.default_error_messages.get("required")]
        )
    ...
    def test_invalid_username(self):
        ...
        form = self.form_class(data=data)
        self.assertFalse(form.is_valid())
        self.assertEqual(form["username"].errors, [UnicodeUsernameValidator.message])
    ...
    def test_password_mismatch_error(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(
            form["password2"].errors, [form.error_messages.get("password_mismatch")]
        )
...
class TestDeleteAccountForm(TestDataMixin, TestCase):
    ...
    def test_email_does_not_exists(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(
            form.non_field_errors(), [form.error_messages.get("invalid_credentials")]
        )
